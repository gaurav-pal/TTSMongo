...
exports.getVerifyEmail = (req, res, next) => {
  ...
  const sendVerifyEmail = (token) => {
    const mailOptions = {
      ...
      subject: 'Please verify your email address on ' +  process.env.COMPANY_NAME,
      text: `Thank you for registering with ` +  process.env.COMPANY_NAME + `.\n\n
...
exports.postReset = (req, res, next) => {
  ...
  const sendResetPasswordEmail = (user) => {
    ...
    const mailOptions = {
      to: user.email,
      from: process.env.SMTP_USER,
      subject: 'Your ' + process.env.COMPANY_NAME + ' password has been changed',
...
exports.postForgot = (req, res, next) => {
  ...
  const sendForgotPasswordEmail = (user) => {
    ...
    const mailOptions = {
      to: user.email,
      from: process.env.SMTP_USER,
      subject: 'Reset your password on ' + process.env.COMPANY_NAME,
